function swUpdateToast(n){try{var e=document.getElementById("sw-update");if(e)return;e=document.createElement("div"),e.id="sw-update",e.setAttribute("role","status"),e.style.cssText="position:fixed;left:12px;bottom:12px;z-index:9999;background:#0f172a;color:#e2e8f0;border:1px solid #23314d;padding:10px 12px;border-radius:10px;box-shadow:0 8px 24px rgba(0,0,0,.35);display:flex;gap:10px;align-items:center";var t=document.createElement("span");t.textContent="New version available";var o=document.createElement("button");o.id="sw-refresh",o.textContent="Refresh",o.style.cssText="background:#2563eb;color:#fff;border:0;padding:6px 10px;border-radius:8px;cursor:pointer",o.addEventListener("click",function(){n&&n()});var r=document.createElement("button");r.textContent="Dismiss",r.className="secondary",r.style.cssText="background:#1b2133;color:#e2e8f0;border:1px solid #2a3550;padding:6px 10px;border-radius:8px;cursor:pointer",r.addEventListener("click",function(){var n=document.getElementById("sw-update");n&&n.remove()}),e.appendChild(t),e.appendChild(o),e.appendChild(r),document.body.appendChild(e)}catch{}}
