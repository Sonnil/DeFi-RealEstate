...
const I18N = {
  ...
  m_title:"Marketplace",m_desc:"Browse listings, open the Invest modal, and propose an allocation (min $500).",
  ...
  a_title:"Admin — Add Property",a_desc:"Add listings. They appear in the Marketplace and are stored locally for this session.",
  ...
  m_title:"Thị trường",m_desc:"Duyệt danh sách, mở hộp đăng ký đầu tư và đề xuất khoản đầu tư (tối thiểu $500).",
  ...
  a_title:"Quản trị — Thêm dự án",a_desc:"Thêm danh sách. Hiển thị ở Thị trường và lưu cục bộ trong phiên.",
